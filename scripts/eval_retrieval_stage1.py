...
def main():
    ...
    print('Computing embeddings for new (stage1) model...')
    ...
    metrics = {
        ...
        'stage1': recall_at_k(sim_new, ks=(1,5,10))
    }

    out_dir = Path('results')
    out_dir.mkdir(exist_ok=True)
    with open(out_dir / 'retrieval_metrics_stage1.json', 'w') as f:
